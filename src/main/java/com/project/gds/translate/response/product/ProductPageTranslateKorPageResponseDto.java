...
@Getter
@Component
public class ProductPageTranslateKorPageResponseDto {
    @Value("${gds.product.kor.productHeadText}")
    private String productHeadText;

    @Value("${gds.product.kor.productNameText}")
    private String productNameText;

    @Value("${gds.product.kor.productDescriptText}")
